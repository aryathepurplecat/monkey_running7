...
function preload () {
  begin_image = loadImage("begin_monkey.png")
...
function setup() {
  ...
  begin = createSprite(770,350,1600,722)
  begin.addImage(begin_image)
...
function draw() {
  ...
  if(obstacle_group.isTouching(monkey)||keyDown("a")) {
    gamestate = "end"
    overSound.play();
  }
